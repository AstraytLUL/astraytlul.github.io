...
Originated from Taipei 🇹🇼, now studying at Nanyang Technological University, Singapore 🇸🇬.

I like to write code and do math.

## My Background

- **Education**: 
    - **NTUsg**: Computer Science, Year 3, NTU Science and Technology Scholarship.
...
I'm currently exploring several directions in my academic and career journey:

**Technical Interests:**
- Machine Learning research, particularly reinforcement learning theory and optimization
- Systems and software engineering
- Mathematics
- Quantitative Trading and Research

**Current Projects:**
- Building pipelines for agentic LLM post-training with RL algorithms at Huawei
- [Planned] Final Year Project on LLM Hallucination Detection under Prof. Sean Du in 2026!

**Long-term Goals:**
- Pursue further studies in Machine Learning, Software Engineering and Mathematics (Targeting: ETH Zurich MSc Computer Science)
- Exploring career paths in ML research, quantitative finance, and software engineering
...
- Learning Japanese and Korean
    - JLPT N3, trying to get N1 before graduation
    - Learned some basic Korean to talk with my friends
- Still exploring OAO